...
description: "Используй этот skill-сценарий для ответов на пользовательские запросы, связанные с таблицами, выгрузкой данных, расчетами по выгрузкам, выбором периодов, выбором таблиц и постановкой задач data-retrieval-agent и coding-agent."
---

# Сценарий выгрузки табличных данных
...
skills, результатами tools или результатами агентов.
