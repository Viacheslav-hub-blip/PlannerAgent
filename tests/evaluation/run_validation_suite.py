...
DEFAULT_REPORT_PATH = PROJECT_ROOT / "runs" / "validation_report.json"
DEFAULT_MARKDOWN_PATH = Path(__file__).resolve().with_name("VALIDATION_CASES.md")
DEFAULT_RUN_PATH = PROJECT_ROOT / "run.py"
WORKER_CASE_ENV = "DEEP_AGENT_VALIDATION_WORKER_CASE"
WORKER_RESULT_ENV = "DEEP_AGENT_VALIDATION_WORKER_RESULT"
...
def synchronize_queries() -> int:
    ...
    from tests.evaluation.sync_validation_queries import (
        load_run_queries,
