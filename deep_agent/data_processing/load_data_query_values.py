...
from deep_agent.data_processing.load_data_query_models import normalize_filter_operator
...
def _format_empty_select_error() -> str:
    ...
    return (
        ...
        "Пример точечного поиска по event_id: LOAD analytics.events\\n"
        "PERIOD event_dt FROM '20260101' TO '20260131'\\n"
        "SELECT event_id, event_dt, event_time\\nWHERE event_id = '<event_id>'\\nLIMIT 1.\n"
