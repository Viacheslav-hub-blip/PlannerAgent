...
READ_TABLE_DESCRIPTION = (
    "load_data\n"
    "---\n"
    "Описание: универсальная безопасная выборка из Spark-таблиц по имени таблицы или view. "
    ...
    "Когда использовать:\n"
    "- нужно прочитать строки, события или агрегаты из Spark-таблицы, которую указал пользователь или skill;\n"
