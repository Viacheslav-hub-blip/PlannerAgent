...
Содержит:
- _think: tool для краткого структурирования промежуточных решений.
...
def _think(
    thought: str = Field(
        ...,
        description="Краткий промежуточный вывод или план следующего шага.",
    ),
) -> str:
    """Возвращает промежуточную мысль без побочных эффектов.

    Args:
        thought: Краткий текст, который помогает агенту структурировать сложное решение.
