...
- `/deep_agent/skills/hit-table/fields.md` - полный список полей `hits` и краткие описания.
- `/deep_agent/skills/hit-table/joins.md` - правила связи `hits` с `cards` и `uko`.

Триггеры для чтения `/deep_agent/skills/hit-table/fields.md`:
