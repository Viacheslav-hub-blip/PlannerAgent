...
description: "Рассчитывай количество сработок, среднюю, минимальную и максимальную сумму транзакций по правилу антифрода в hits. Используй для вопросов о статистике transaction_amount или transaction_amount_in_rub по названию, идентификатору либо фрагменту main_rule."
---
...
5. Если строк много или результат ушёл в `.pkl`, считай статистику через `python`.
