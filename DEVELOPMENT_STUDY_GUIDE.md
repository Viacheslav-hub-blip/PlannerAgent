...
Главная идея проекта: код отвечает за механику агента, а бизнес-смысл таблиц и правил живет в `deep_agent/resources/skills`.
...
- `deep_agent/resources/config/defaults.json`
...
tools описываются только в descriptions инструментов. Доменные знания о таблицах хранятся в `resources/skills`.
...
- `deep_agent/resources/skills/**/SKILL.md`
...
- `/skills/` -> `deep_agent/resources/skills`
