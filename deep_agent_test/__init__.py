"""Пакет аналитического native DeepAgents агента.
...
from deep_agent_test.core.analytics_deep_agent import build_analytics_deep_agent
...
__all__ = ["build_analytics_deep_agent", "build_spark_data_tools", "load_deep_agent_settings"]
