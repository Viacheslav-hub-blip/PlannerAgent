...
`deep_agent_test/test_basket.json` и `deep_agent_test/TEST_CASES.md`.
...
`runs/test_basket_report.json`. Команда одинакова для Windows и Linux: раннер
...
`deep_agent_test/test_basket.json` ограничивает число одновременно работающих
