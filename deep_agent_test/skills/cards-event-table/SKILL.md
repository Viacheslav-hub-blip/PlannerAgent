...
- `event_time` — время raw-события в читаемом формате `YYYY-MM-DD HH:MM:SS`. Формат совместим с hits; для связи hits → cards_event достаточно `event_id` или `event_dt`.
